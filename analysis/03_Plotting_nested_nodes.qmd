...
load("../results/plots/graph")
  ...
  #Mudar nome da variável - nodelist_filtered
nodelist_filtered <- vroom::vroom("../results/orthology_data/nodelist.csv") %>%
...
```{r}
graph_RedeR <- getGraphFromRedeR(type = "node",unit = 'npc' )
