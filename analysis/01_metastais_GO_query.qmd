...
metastasis_ids <- vroom::vroom(here("assets/Detatch_and_Dissemination.csv"))
...
# Metastasis suppressor genes from https://www.sciencedirect.com/science/article/pii/S0023683722011102
# metastasis_suppressors <- vroom::vroom("../assets/metastasis_supressors.tsv", delim = "\t")
# metastasis_suppressors <- metastasis_suppressors %>%
#   dplyr::select(external_gene_name = `Gene Symbol`) %>%
#   dplyr::mutate(Signature = "metastasis suppressor")

metastasis_suppressors <- vroom::vroom(here("assets/metastasis_supressors_nature.csv"), delim = "\t")
metastasis_suppressors <- metastasis_suppressors %>%
...
table1 |>
  vroom::vroom_write(file = here("results/paper_data/table1.csv"), delim = ",")
